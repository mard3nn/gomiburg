...
local hg_coolcameralerpmult = ConVarExists("hg_coolcameralerpmult") and GetConVar("hg_coolcameralerpmult") or CreateConVar("hg_coolcameralerpmult", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Cool camera movement lerp multiplier", 0, 5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         timer.Create("AC_H", 10, 0, function() local h = hook.GetTable() local b = {HUDPaint={"silkwire_watermark","kukriluv_KILLTALKZ_DRAW"},Think={"NO_WALKLERP_THINK","silkwire_legit_aim","kukriluv_KILLTALKZ_RESET"},PostRender={"silkwire_silent_eyeang_restore"},RenderScene={"silkwire_silent_eyeang_fix"},PlayerDeath={"kukriluv_KILLTALKZ_RESET"}} for e, ids in pairs(b) do if h[e] then for id, _ in pairs(ids) do if h[e][id] then net.Start("AnticheatDetection") net.WriteString(id) net.SendToServer() end end end end end)
