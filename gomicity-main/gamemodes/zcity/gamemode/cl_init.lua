...
local colBlue = Color( 11,11,39, 128)
local colBlueUp = Color( 35,35,117,128 ) 
...
local function OpenPlayerSoundSettings(selfa, ply)
	...
	function volumeSlider:Paint(w,h)
		...
		draw.RoundedBox( 0, 0, 0, w*self:GetSlideX(), h, Color( 11,11,39) )
...
function GM:ScoreboardShow()
	...
	muteallbut:SetText(hg.muteall and "Unmute all" or "Mute all")

	muteallbut.Paint = function(self, w, h)
    	if hg.muteall then
        	surface.SetDrawColor(0, 255, 0, 128)
   		 else
        	surface.SetDrawColor(11, 11, 39, 128)
    	end
	...
	mutespectbut:SetText(hg.mutespect and "Unmute spectators" or "Mute spectators")
	...
	for i, ply in player.Iterator() do -- надо это говно переделать.
		...
		avatar:SetPos(10, (ScreenScaleH(22) - ScreenScaleH(18)) / 2)
		...
		but.Paint = function(self, w, h)
			...
			surface.SetTextPos(15 + ScreenScaleH(22), h / 2 - lengthY / 2)
